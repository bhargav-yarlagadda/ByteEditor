    ...
    <div className='flex p-4 lg:flex-col flex-row items-center justify-center bg-[#000] h-full'>
        ...
        <div className='flex gap-5 flex-col'>
          ...
          onClick={()=>{
           ...
           className='bg-white py-2 hover:scale-105 transition-all ease-in 1s hover:text-white hover:bg-[#1f1e1e] flex items-center justify-evenly lg:mt-16 rounded-full '>
